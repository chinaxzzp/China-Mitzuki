...
let txt = `
¡𝐇𝐨𝐥𝐚! 𝐒𝐨𝐲 *${botname}* (${(conn.user.jid == global.conn.user.jid ? '𝐏𝐫𝐢𝐧𝐜𝐢𝐩𝐚𝐥' : '𝐒𝐮𝐛-𝐁𝐨𝐭')})
𝐀𝐪𝐮𝐢 𝐭𝐢𝐞𝐧𝐞𝐬 𝐥𝐚 𝐥𝐢𝐬𝐭𝐚 𝐝𝐞 𝐦𝐢𝐬 𝐜𝐨𝐦𝐚𝐧𝐝𝐨𝐬.

╭┈ ↷
│ ✐ 𝓓𝓮𝔀𝓮𝓵𝓸𝓹𝓮𝓭 𝓫𝔂 ${etiqueta}
│ ✐ ꒷ꕤ🇨🇳ദ ɪɴsᴛᴀɢʀᴀᴍ ෴
│ instagram.com/its.chinitaaa_
│ ✐ ꒷ꕤ🇨🇳ദ ᴄᴀɴᴀʟ ᴏғɪᴄɪᴀʟ ෴
...
✦ *#testwelcome* • *#testbye*
→ testea el mensaje de bienvenida/despedida personalizado.
